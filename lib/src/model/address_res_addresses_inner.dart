...
class AddressResAddressesInner {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AddressResAddressesInner &&
  ...
  @override
  String toString() => 'AddressResAddressesInner[zipCode=$zipCode, prefCode=$prefCode, prefName=$prefName, prefKana=$prefKana, prefRoma=$prefRoma, cityCode=$cityCode, cityName=$cityName, cityKana=$cityKana, cityRoma=$cityRoma, townName=$townName, townKana=$townKana, townRoma=$townRoma]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AddressResAddressesInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AddressResAddressesInner[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AddressResAddressesInner> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<AddressResAddressesInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AddressResAddressesInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AddressResAddressesInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
