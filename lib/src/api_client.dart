...
// ignore_for_file: unused_element, unused_import, unnecessary_getters_setters
...
class ApiClient {
  ApiClient({
    this.basePath = 'https://api.da.pf.japanpost.jp',
    this.authentication,
  });
  ...
  static dynamic fromJson(
    ...
    try {
      switch (targetType) {
        ...
        case 'AddressReq':
          return AddressReq.fromJson(value);
        case 'AddressRes':
          return AddressRes.fromJson(value);
        case 'AddressResAddressesInner':
          return AddressResAddressesInner.fromJson(value);
        case 'BadRequest':
        ...
        case 'JtokenReq':
          return JtokenReq.fromJson(value);
        case 'JtokenRes':
          return JtokenRes.fromJson(value);
        case 'NotFound':
          return NotFound.fromJson(value);
        case 'SearchcodeSearchRes':
          return SearchcodeSearchRes.fromJson(value);
        case 'SearchcodeSearchResAddressesInner':
          return SearchcodeSearchResAddressesInner.fromJson(value);
        case 'Unauthorized':
